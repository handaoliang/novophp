 ...
 */
//整站全局配置文件
var_dump(dirname(dirname(__FILE__)).DIRECTORY_SEPARATOR."Configs".DIRECTORY_SEPARATOR.ENVIRONMENT.DIRECTORY_SEPARATOR."AppsConfig.php");
var_dump(file_exists(dirname(dirname(__FILE__)).DIRECTORY_SEPARATOR."Configs".DIRECTORY_SEPARATOR.ENVIRONMENT.DIRECTORY_SEPARATOR."AppsConfig.php"));exit;
if(file_exists(dirname(dirname(__FILE__)).DIRECTORY_SEPARATOR."Configs".DIRECTORY_SEPARATOR.ENVIRONMENT.DIRECTORY_SEPARATOR."AppsConfig.php")){
    require_once dirname(dirname(__FILE__)).DIRECTORY_SEPARATOR."Configs".DIRECTORY_SEPARATOR.ENVIRONMENT.DIRECTORY_SEPARATOR."AppsConfig.php";
}else{
