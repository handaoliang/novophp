 ...
 */
class RedisExceptionAlias extends Exception {
}
...
class Redisent {
    ...
    function __call($name, $args) {
        ...
        switch (substr($reply, 0, 1)) {
            /* Error reply */
            case '-':
                throw new RedisExceptionAlias(substr(trim($reply), 4));
                break;
            /* Inline reply */
            case '+':
            ...
            case ':':
                ...
                break;
            default:
                throw new RedisExceptionAlias("invalid server response: {$reply}");
                break;
        }
        /* Party on */
        return $response;
