...
/**
 * @package
 * @file                 $RCSfile: NovoSmarty.class.php,v $
...
if(!defined('NOVOPHP_VENDOR_DIR')){
	echo "NOVOPHP_VENDOR_DIR is not defined,Error File: NovoSmarty.class.php";
	exit;
}
require_once NOVOPHP_VENDOR_DIR."/Smarty/Smarty.class.php";
