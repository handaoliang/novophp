...
/**
 * @package
 * @file                 $RCSfile: NovoRedis.class.php,v $
...
class NovoRedis
{
    ...
    {
        $this->_HOST = REDIS_DB_HOST;
        $this->_PORT = REDIS_DB_PORT;
        $this->_TIMEOUT = REDIS_DB_TIMEOUT;
        $this->_DBNAME = REDIS_DB_NAME;
        $this->_CTYPE = REDIS_DB_CONNECT_TYPE;
