...
if(!defined('NOVOPHP_VENDORS_DIR')){
	echo "NOVOPHP_VENDORS_DIR is not defined, WelcomeEmail.Job";
	exit;
}
require_once NOVOPHP_VENDORS_DIR.'/MailMime/mime.php';

class ResetPasswordEmail_Job extends BaseEmailServerJobs
{
    public function perform()
    {
        ...
        $mailBody = $this->getMailBody($serverJobsViewsDir, $this->args, "ResetPasswordEmail_Job");
