...
/**
 * @package
 * @file                 $RCSfile: BaseStringEncrypt.class.php,v $
...
echo $stringCn;
echo "\n\n=================\n\n";
$aa = BaseStringEncrypt::disorganizeString($stringEn);
echo $aa;
echo "\n\n";
echo BaseStringEncrypt::unDisorganizeString($aa);
echo "\n\n=================\n\n";
$bb = BaseStringEncrypt::encryptString($stringCn, $key);
echo $bb;
echo "\n\n";
echo BaseStringEncrypt::decryptString($bb, $key);
echo "\n\n=================\n\n";
$cc = BaseStringEncrypt::xxteaEncrypt($stringCn, $key);
echo $cc;
echo "\n\n";
echo BaseStringEncrypt::xxteaDecrypt($cc, $key);
echo "\n\n=================\n\n";
 */
