 ...
 */
function createHashPassword($originalPassword, $passwordSalt)
{
 ...
 * @return string
 **/
function getHashFileSavePath($fileName='', $localFilePath='')
{
    if($fileName == ''){
        return false;
    }
 ...
 * @return string
 **/
function getHashFileWebPath($fileName, $baseWebPath="")
{
    $pattern = "/(http[s]?:\/\/)/is";
 ...
 * @return boolean
 **/
function checkVerifyToken($hashToken)
{
